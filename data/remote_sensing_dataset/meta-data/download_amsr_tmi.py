...
if __name__ == '__main__':
    ...
    # urls = get_url('http://data.remss.com/amsr2/bmaps_v08/Y2022/M10/')
    urls = get_url('https://data.remss.com/amsr2/ocean/L3/v08.2/3day/2023/')
    # urls = get_url('http://data.remss.com/ccmp/v02.1.NRT/Y2022/M03/')
    for url in urls:
        if '-02-' in url:
            print(url)
