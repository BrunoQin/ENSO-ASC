...
from train.reanalysis_models.extra_model import *
from train.reanalysis_models.sst_model import *
...
def model_factory(adj, variables, reuse=True):
    ...
    for vrb in params.reanalysis_variables:
        inputs_list.append(Input(shape=(params.sequence_length, 30, 30, 1), name=vrb))
